...
namespace Studing_Journal
{
    class ExcelDocument
    {
        ...
        {
            string name = Registry_Class.DirPath + Group_name + DateTime.Now.ToString("_hh_mm_ss_dd_MM_yyyy") + ".xlsx";
            ...
            try
            {
                ...
                worksheet.Range[worksheet.Cells[3, 3], worksheet.Cells[3, 2 + dtDiscipline.Rows.Count]].Merge();
                ...
                worksheet.Cells[4, dtDiscipline.Rows.Count + 3] = "Кол-во часов по уважительной причине";
                worksheet.Cells[4, dtDiscipline.Rows.Count + 4] = "Кол-во часов по не уважительной причине";
                ...
                conf_cell.HorizontalAlignment = excel.XlHAlign.xlHAlignCenter;
                conf_cell.WrapText = true;
                worksheet.Range[worksheet.Cells[3, 3 + dtDiscipline.Rows.Count], worksheet.Cells[3, 5 + dtDiscipline.Rows.Count]].Merge();
                worksheet.Cells[3, 3 + dtDiscipline.Rows.Count] = "Пропуски";
                conf_cell = worksheet.Cells[3, 3 + dtDiscipline.Rows.Count];
                conf_cell.HorizontalAlignment = excel.XlHAlign.xlHAlignCenter;
                conf_cell.VerticalAlignment = excel.XlHAlign.xlHAlignCenter;
                worksheet.Range[worksheet.Cells[2, 1], worksheet.Cells[2, 5 + dtDiscipline.Rows.Count]].Merge();
                worksheet.Cells[2, 1] = "Сводная ведомость группы " + Group_name;
                conf_cell = worksheet.Cells[2, 1];
                conf_cell.HorizontalAlignment = excel.XlHAlign.xlHAlignCenter;
                conf_cell.VerticalAlignment = excel.XlHAlign.xlHAlignCenter;
                conf_cell.WrapText = true;
                worksheet.Range[worksheet.Cells[1, 1], worksheet.Cells[1, 5 + dtDiscipline.Rows.Count]].Merge();
                ...
                conf_cell.WrapText = true;
                conf_cell.RowHeight = 150;
                worksheet.Range[worksheet.Cells[dtStudents.Rows.Count + 5, 1], worksheet.Cells[dtStudents.Rows.Count + 5, 2]].Merge();
                worksheet.Range[worksheet.Cells[dtStudents.Rows.Count + 6, 1], worksheet.Cells[dtStudents.Rows.Count + 6, 2]].Merge();
                worksheet.Range[worksheet.Cells[dtStudents.Rows.Count + 7, 1], worksheet.Cells[dtStudents.Rows.Count + 7, 2]].Merge();
                worksheet.Range[worksheet.Cells[dtStudents.Rows.Count + 8, 1], worksheet.Cells[dtStudents.Rows.Count + 8, 2]].Merge();
                ...
                conf_cell.VerticalAlignment = excel.XlHAlign.xlHAlignCenter;
                conf_cell.WrapText = true;
                worksheet.Cells[dtStudents.Rows.Count + 10, 2] = "Заместитель директора по УМР __________________";
                worksheet.Cells[dtStudents.Rows.Count + 11, 2] = "Педагог организатор __________________";
                worksheet.Cells[dtStudents.Rows.Count + 12, 2] = DateTime.Now.ToLongDateString();
                excel.Range brdRange = worksheet.Range[worksheet.Cells[1, 1], worksheet.Cells[dtStudents.Rows.Count + 8, dtDiscipline.Rows.Count + 5]];
                brdRange.Borders.LineStyle = excel.XlLineStyle.xlContinuous;
                worksheet.VPageBreaks.Add(worksheet.Range[dtDiscipline.Rows.Count + 5]);
                worksheet.HPageBreaks.Add(worksheet.Range[dtStudents.Rows.Count + 12]);
                //application.ActiveWindow.View = excel.XlWindowView.xlPageLayoutView;
                application.ActiveWindow.View = excel.XlWindowView.xlPageBreakPreview;
                //workbook = excel.XlWindowView.xlPageLayoutView;
            }
            catch (Exception ex)
            {
