...
namespace Studing_Journal
{
    class DataBaseTables
    {
        ...
        public string qrAccess_rights = "select [ID_Access_rights],[Access_rights_name],[Head_of_Department],[Teacher], [CCMC], [Director], [Deputy_Director],[Student] from[dbo].[Access_rights] where[Access_rights_Logical_Delete] = 0",
            ...
            qrDepartment = "select [ID_Department],[Department_Number],[Department_Name],[Standard_ID], [Standard_name], 'Код: '+[Department_Number]+' - '+[Department_Name] as \"Departments_List\" from[dbo].[Department] inner join[dbo].[Standard] on[dbo].[Standard].[ID_Standard] = [dbo].[Department].[Standard_ID] where [Standard_Logical_Delete] = 0 and[Department_Logical_Delete] = 0",
            ...
            qrPost = "select [dbo].[Post].[ID_Post],[dbo].[Post].[Post_title], [dbo].[Post].[Post_ID], a.ID_Post as \"ID_Deputy\", a.Post_title as \"Deputy_Post\"  from[dbo].[Post] full outer join[dbo].[Post] a on a.Post_ID = [dbo].[Post].[ID_Post] where[dbo].[Post].[Post_Logical_Delete] = 0",
